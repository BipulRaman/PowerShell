...
.NOTES
    ...
    * Enhanced and Converted to PS Module along with sample - thanks to @BipulRaman
    * Example updated and detailed - thanks to @BipulRaman
   To Do:
